"""
Benchmark for v4 codec (BPP_Y=3, BPP_C=2, 64,200 bytes/frame).

Usage:
    python benchmark_v4.py                  # default 10 MB
    python benchmark_v4.py 50               # 50 MB test
    python benchmark_v4.py 1 5 10 25 50     # multiple sizes
"""
...
PY = _params(BLOCK_SIZE, FRAME_WIDTH, FRAME_HEIGHT, BPP_Y_V4)
PC = _params(BLOCK_SIZE, CHROMA_W, CHROMA_H, BPP_C_V4)
BPF_Y = PY["bpf"]
BPF_C = PC["bpf"]
BPF = BPF_Y + 2 * BPF_C
BYTES_PER_FRAME = BPF // 8  # 64,200
...
def main():
    ...
    print("=" * 75)
    print("  v4 Benchmark  (BPP_Y=3, BPP_C=2, 64,200 bytes/frame)")
